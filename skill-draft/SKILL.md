---
name: in-app-agent-comment-controls
description: "Draft skill from X Artifact Factory: Translate UI-region comments into bounded coding-agent tasks with selector context, screenshot evidence, patch summaries, and human accept/revise gates."
version: 0.1.0
status: draft
---

# In-App Agent Comment Controls Skill Draft

## Trigger
Use when a task needs this repeatable workflow: Translate UI-region comments into bounded coding-agent tasks with selector context, screenshot evidence, patch summaries, and human accept/revise gates.
